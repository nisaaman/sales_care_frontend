...
export default function ProfitabilityAnalysisReport() {
    ...
    const generateProfitabilityAnalysisReport = () => {
        ...
        const URL = `${process.env.REACT_APP_API_URL}/api/reports/profitability-analysis` + queryParams;
    ...
    const preview = () => {
        ...
        const dataURL = `${process.env.REACT_APP_API_URL}/api/reports/profitability-analysis` + queryParams;
