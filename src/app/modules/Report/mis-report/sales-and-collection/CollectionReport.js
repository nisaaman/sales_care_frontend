...
export default function CollectionReport() {
    ...
    const download = () => {
        ...
        const URL = `${process.env.REACT_APP_API_URL}/api/reports/collection` + queryParams;
    ...
    const preview = () => {
        ...
        const data = `${process.env.REACT_APP_API_URL}/api/reports/collection` + queryParams;
    ...
    return (
        <>
            <div>
                <MisReportBreadCrum menuTitle="Collection Report" />
            </div>
            <div>
                <Card>
                    <CardBody>
