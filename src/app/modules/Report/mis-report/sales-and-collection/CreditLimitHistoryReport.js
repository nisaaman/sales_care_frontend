...
export default function CreditLimitHistoryReport() {
    ...
    const download = () => {
        ...
        queryString += '&nationalLocationChecked=' + nationalLocationChecked;
        queryString += '&locationTypeLevel=' + (nodes.length > 0 ? nodes[0].locationTypeLevel : 0);
        queryString += '&locationIds=' + locationIds;
        queryString += '&salesOfficerIds=' + soList.join(',');
        queryString += '&distributorIds=' + distributorIds.join(',');
        ...
        queryString += '&allChecked=' + allChecked;
        queryString += '&locationTypeData=' + locationTypeData;
